package gr.cite.intelcomp.evaluationworkbench.webclient;
...
public class WebClientUtils {
    ...
    private static String getParameterName(Field field) {
        ...
        if (field.isAnnotationPresent(ParameterName.class)) {
            result = field.getAnnotation(ParameterName.class).value();
        }
        return result;
    }
}
